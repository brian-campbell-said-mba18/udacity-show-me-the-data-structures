...
## Code efficiency.
In using dictionaries in both the intersection and Union functions, both functions have a worst case O(n) time complexity. Also, both funcitons have a worst case O(n) space complexity. In this problem, n is defined as the combined number of elements in list 1 and list 2.
